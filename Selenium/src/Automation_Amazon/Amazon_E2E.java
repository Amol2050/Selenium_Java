...
public class Amazon_E2E 
{
	...
	public void E2E() throws EncryptedDocumentException, IOException
	{
		...
		Card_no.sendKeys("4598450029192553");
		
		//WebElement Month = driver.findElement(By.xpath("(//div[@class='a-row']/span/select)[1]"));
		
		Select month = new Select(driver.findElement(By.xpath("(//div[@class='a-row']/span/select)[1]")));	
		month.selectByValue("12");
		
		Select year = new Select(driver.findElement(By.xpath("(//div[@class='a-row']/span/select)[2]")));	
		year.selectByValue("2025");
		
		WebElement Submit = driver.findElement(By.xpath("//span[.='Enter card details']"));
		Submit.click();
		...
		WebElement payment_method = driver.findElement(By.xpath("(//span[.='Use this payment method'])[1]"));
