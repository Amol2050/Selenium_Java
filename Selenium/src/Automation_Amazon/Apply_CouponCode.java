...
public class Apply_CouponCode 
{
	...
	public void Apply_Coupon() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		//WebElement Use_Address = driver.findElement(By.cssSelector("#shipToThisAddressButton"));
		//Use_Address.click();
		
		Thread.sleep(2000);
		WebElement Coupon = driver.findElement(By.name("ppw-claimCode"));
		Coupon.sendKeys("AMZN007");
		
		WebElement Apply = driver.findElement(By.xpath("//input[@value='Apply']"));
		Apply.sendKeys("AMZN007");
